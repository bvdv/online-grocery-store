...
function grocery_store_woocommerce_scripts() {
	wp_enqueue_style( 'grocery-store-woocommerce-style', get_template_directory_uri() . '/woocommerce.css' );
 ...
 */
function grocery_store_woocommerce_products_per_page() {
	return 12;
}
add_filter( 'loop_shop_per_page', 'grocery_store_woocommerce_products_per_page' );
 ...
 */
function grocery_store_woocommerce_thumbnail_columns() {
	return 4;
}
add_filter( 'woocommerce_product_thumbnails_columns', 'grocery_store_woocommerce_thumbnail_columns' );
...
if ( ! function_exists( 'grocery_store_woocommerce_product_columns_wrapper' ) ) {
	/**
	 * Product columns wrapper.
	 *
	 * @return  void
	 */
	function grocery_store_woocommerce_product_columns_wrapper() {
		$columns = grocery_store_woocommerce_loop_columns();
		echo '<div class="columns-' . absint( $columns ) . '">';
	}
}
add_action( 'woocommerce_before_shop_loop', 'grocery_store_woocommerce_product_columns_wrapper', 40 );

if ( ! function_exists( 'grocery_store_woocommerce_product_columns_wrapper_close' ) ) {
	/**
	 * Product columns wrapper close.
	 *
	 * @return  void
	 */
	function grocery_store_woocommerce_product_columns_wrapper_close() {
		echo '</div>';
	}
}
add_action( 'woocommerce_after_shop_loop', 'grocery_store_woocommerce_product_columns_wrapper_close', 40 );
